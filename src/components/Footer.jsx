...
function Footer() {
  ...
  return (
    <div className="bg-[#0E0D10] flex flex-row">
      <div
        id="contact"
        className=" px-6 mx-10 lg:mx-[300px]  fill-[#5918DF] text-[#5918DF]"
      >
        <div className="">
          <div className="flex flex-row gap-5 -ml-[35px]  mb-20 items-center">
            <div className="h-3 w-3 bg-[#5918DF] border-2 border-[#5918DF] rounded-full"></div>
            <div className=" text-lg -ml-4 font-light text-[#746C79]">
              Contact /&gt;
            </div>
          ...
          <div className=" flex flex-col">
            ...
            <div className="flex  gap-4  md:flex-row flex-col mb-10  font-normal text-lg justify-start  ">
              <a
          ...
          <button className="transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-00  text-xl font-semibold mt-2 px-4 py-2 mb-32 bg-[#5918DF] hover:bg-gradient-to-r from-orange-700 to-orange-400 text-white rounded-3xl">
      ...
      {/* self intro-------------------------->>> */}
      <div className="flex justify-center  items-center mx-4 my-2 flex-col rounded-full text-center text-white  w-100">
        <div
